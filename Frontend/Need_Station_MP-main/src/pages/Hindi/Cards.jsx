...
const Cards = () => {
  return <>
    ...
    <div className="container">
      <h2 className={`text-center mb-4 ${styles["heading"]}`}>हमारी सेवाएं देखें</h2>
      <div className="row g-4">
        <div className="col-md-4">
          <div className={`card ${styles["card"]}`}>
            ...
            <div className="card-body">
              ...
              <p className={`card-text ${styles["cardBody"]}`}>वरिष्ठ नागरिकों की अनूठी आवश्यकताओं को पूरा करने के लिए दयालु और पेशेवर देखभाल।</p>
        ...
        <div className="col-md-4">
          <div className={`card ${styles["card"]}`}>
            <img src={image2} className="card-img-top" alt="बुनियादी आवश्यकताएं"/>
            <div className="card-body">
              <h5 className={`card-title ${styles["cardTitle"]}`}>बुनियादी आवश्यकताएं</h5>
              <p className={`card-text ${styles["cardBody"]}`}>विश्वसनीय स्थानीय इलेक्ट्रीशियन, प्लंबर और अन्य से घरेलू आवश्यकताएं।</p>
        ...
        <div className="col-md-4">
          <div className={`card ${styles["card"]}`}>
            <img src={image3} className="card-img-top" alt="घरेलू सेवाएं"/>
            <div className="card-body">
              <h5 className={`card-title ${styles["cardTitle"]}`}>मेड सेवाएं</h5>
